...
public class EssensTyp implements java.io.Serializable {
	...
	public static final EssensTyp Lamm = null; //missing
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://mensaParser.provider.elis.unipotsdam.de/", "essensTyp"));
    }
    /**
